...
exports.getcustomerInvoices = exports.getInvoiceById = exports.createInvoice = void 0;
var uuid_1 = require("uuid");
var invoices = [];
var createInvoice = function (createInvoiceDto) {
...
var getInvoiceById = function (id) {
    var invoice = invoices.find(function (invoice) { return invoice.id === id; });
    if (invoice)
        return invoice;
    return null;
};
...
var getcustomerInvoices = function (customerId) { return __awaiter(void 0, void 0, void 0, function () {
    var customerInvocies;
    return __generator(this, function (_a) {
        customerInvocies = invoices.filter(function (invlice) { return invlice.customerId === customerId; });
        if (customerInvocies)
            return [2 /*return*/, customerInvocies];
